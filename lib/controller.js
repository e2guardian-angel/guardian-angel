...
const GUARDIAN_TLS_PATH = `${SECRETS_PATH}/guardian-tls`
...
var Controller = defclass({
    ...
    pullTLS: async function() {
        try {
            let tlsResource = await this.kubeGet(GUARDIAN_TLS_PATH);
            kubeData.tls = {};
    ...
    pushTLS: async function() {
        ...
        try {
            ...
            const result = await this.kubeApply(SECRETS_PATH, GUARDIAN_TLS_PATH, tlsResource);
